	...
	function fc_generateHTML() {
		// <img src="/upload/frontend/css/img/calendario/cerrar.gif" alt="Cerrar" />
		var html = '<div class="wrapper-calendario"><table border="0" cellpadding="0" cellspacing="0"><tr class="header primera"><td class="fc_head primera" colspan="6"><div style="float: right"></div>Calendario</td><td class="fc_date ultima" onclick="getCalendar(\'' + this.id + '\').hide(); return false;"><a href="#" class="cerrar" title="Cerrar"><img src="/upload/frontend/css/img/calendario/cerrar.gif" alt="Cerrar" /></a></td></tr>';
		html += '<tr class="selector"><td class="fc_date ano-anterior primera"><a href="#" title="Año anterior" onclick="getCalendar(\'' + this.id + '\').moveMonth(-12); return false;">&laquo;<span class="indentado"> Año anterior</span></a></td><td class="fc_date mes-anterior"><a href="#" title="Mes anterior" onclick="getCalendar(\'' + this.id + '\').moveMonth(-1); return false;">&lt;<span class="indentado"> Mes anterior</span></a></td><td colspan="3" class="fc_wk mes-actual">' + fc_months[this.showDate.getMonth()] + ' ' + fc_getYear(this.showDate) + '</td><td class="fc_date mes-siguiente"><a href="#" title="Mes siguiente" onclick="getCalendar(\'' + this.id + '\').moveMonth(1); return false;">&gt;<span class="indentado"> Mes siguiente</span></a></td><td class="fc_date ano-siguiente ultima"><a href="#" title="Año siguiente" onclick="getCalendar(\'' + this.id + '\').moveMonth(12); return false;">&raquo;<span class="indentado"> Año siguiente</span></a></td></tr>';
		html += '<tr class="dias-semana"><td width="14%" class="fc_wk primera">L</td><td width="14%" class="fc_wk">M</td><td width="14%" class="fc_wk">X</td><td width="14%" class="fc_wk">J</td><td width="14%" class="fc_wk">V</td><td class="fc_wknd" width="14%">S</td><td class="fc_wknd ultima" width="14%">D</td></tr>';
		html += '<tr>';
		var dow = 0;
		var i, style;
		...
		for (i = 1; i <= totald; i++) {
			...
			if (this.showDate.getMonth() == this.date.getMonth() && this.showDate.getYear() == this.date.getYear() && this.date.getDate() == i) {
				style = ' style="background: #64a3cb; color: #fff; border-top-color: #2e4b5d; border-left-color: #2e4b5d;"';
			} else {
				style = '';
			}
			html += '<td class="fc_date" onclick="getCalendar(\'' + this.id + '\').setDate(' + i + ', ' + this.showDate.getMonth() + ', ' + this.showDate.getFullYear() + '); return false;" ' + style + '>' + i + '</td>';
			dow++;
			if (dow == 7) {
				html += '</tr>';
				dow = 0;
